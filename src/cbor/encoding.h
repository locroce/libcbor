...
extern "C"
{
    ...
    _CBOR_NODISCARD CBOR_EXPORT size_t cbor_encode_uint_urdflib(uint64_t, unsigned char *,
                                                                size_t);
    ...
    _CBOR_NODISCARD CBOR_EXPORT size_t cbor_encode_tag_urdflib(uint64_t, unsigned char *,
                                                       size_t);
